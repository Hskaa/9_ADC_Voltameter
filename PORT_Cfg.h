...
#define PORTD_PIN2_DIR        		1   //input
#define PORTD_PIN3_DIR        		1   //input
...
#define PORTD_PIN2_INITIAL_VALUE	1      //pull up activation
#define PORTD_PIN3_INITIAL_VALUE	1	   //pull up activation
